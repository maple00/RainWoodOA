package com.rainwood.customchartview.xmstock;
...
import com.rainwood.customchartview.R;
...
import com.rainwood.customchartview.xmstock.bean.DataPoint;
import com.rainwood.customchartview.xmstock.bean.FenbuInfo;
import com.rainwood.customchartview.xmstock.bean.FenbuNum;

import java.util.ArrayList;
import java.util.List;

import static com.rainwood.customchartview.utils.FontUtil.getFontHeight;
import static com.rainwood.customchartview.utils.FontUtil.getFontLeading;
import static com.rainwood.customchartview.utils.FontUtil.getFontlength;
...
public class BarChart extends BaseChart {
    ...
    private void evaluatorByData() {
        ...
        float lableHeight = getFontHeight(paintLabel);
        paintLabel.setTextSize(textSize_Y);
        float yMarkHeight = getFontHeight(paintLabel);
        paintLabel.setTextSize(textSize_X);
        float xLableHeight = getFontHeight(paintLabel);
        //图表主体矩形
    ...
    public void drawDefult(Canvas canvas) {
        ...
        paintLabel.setTextSize(lableTextSize);
        float doubleTextLength = getFontlength(paintLabel, "上涨");
        float downTextLength = getFontlength(paintLabel, numData.getDown() + "家");
        float downStopTextLength = getFontlength(paintLabel, numData.getDown_stop() + "家");
        float equalTextLength = getFontlength(paintLabel, numData.getEqual() + "家");
        float stopTextLength = getFontlength(paintLabel, numData.getStop() + "家");
        ...
        float lableHeight = getFontHeight(paintLabel);
        float lableLead = getFontHeight(paintLabel);
        //第一行
    ...
    public void drawChart(Canvas canvas) {
        if (null == fenbuData)
            return;
        paintLabel.setTextSize(textSize_X);
        float xLableLead = getFontLeading(paintLabel);
        paintLabel.setTextSize(textSize_Y);
        float yLableHeight = getFontHeight(paintLabel);
        float yLableLead = getFontLeading(paintLabel);
        int barColorIndex = 0;
        for (int i = 0; i < itemCenterPointList.size(); i++) {
            ...
            float xLableLength = getFontlength(paintLabel, dataPoint.getValueX());
            ...
            xLableLength = getFontlength(paintLabel, (int) dataPoint.getValueY() + "");
