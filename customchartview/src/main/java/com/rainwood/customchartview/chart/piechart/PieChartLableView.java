package com.rainwood.customchartview.chart.piechart;
...
import com.rainwood.customchartview.chart.bean.PieChartBean;
...
import static com.rainwood.customchartview.chart.piechart.PieChartLayout.TAG_MODUL.MODUL_LABLE;
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            if (MODUL_LABLE == tagModul) {
                ...
                if (tagType == PieChartLayout.TAG_TYPE.TYPE_NUM) {
                    ...
                    tagText = decimalFormat.format((bean.getNum() / (float) total) < 1.0f ? "" : (bean.getNum() / (float) total));
                }
