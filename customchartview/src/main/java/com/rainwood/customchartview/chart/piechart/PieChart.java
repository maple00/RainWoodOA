...
import static com.rainwood.customchartview.chart.piechart.PieChartLayout.TAG_MODUL.MODUL_CHART;
...
//            LogUtil.i(TAG, "直线坐标：start=("+startX+","+startY +")  end=("+endX+","+endY+")"+"   lineAngle="+lineAngle+"  isRight="+isRight);
                ...
                if (tagType == PieChartLayout.TAG_TYPE.TYPE_NUM) {
                    ...
                    // 数量过多显示拥挤 -- 小于百分之1 的不显示
                    int compareResult = tagText.compareTo("1.0%");
                    if (compareResult < 0) {
                        tagText = "";
                    }
                }
