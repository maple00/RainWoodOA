...
public class ActivityStackManagerUtil implements Application.ActivityLifecycleCallbacks {
    ...
    private ActivityStackManagerUtil() {
        stack = new Stack<>();
    }

    public static ActivityStackManagerUtil getInstance() {
        //
        return Instance.INSTANCE;
    }

    private static class Instance {
        static ActivityStackManagerUtil INSTANCE = new ActivityStackManagerUtil();
    }
