...
import com.rainwood.oa.ui.adapter.FollowRecordAdapter;
...
public final class FollowRecordActivity extends BaseActivity implements IRecordCallbacks {
    ...
    protected void initView() {
        ...
        // 创建适配器
        mFollowRecordAdapter = new FollowRecordAdapter();
        // 设置适配器
        followRecordsView.setAdapter(mFollowRecordAdapter);
        // 设置刷新属性
    ...
    protected void initEvent() {
        ...
        mFollowRecordAdapter.setClickChecked((record, selected) -> {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_page_right_title:
                ...
                mFollowRecordAdapter.setShowSelector(managerControlFlag);
    ...
    private void isSelectedAll(boolean checked) {
        ...
        mFollowRecordAdapter.setRecordList(mRecordList);
    ...
    public void getCustomFollowRecords(List<CustomFollowRecord> recordList) {
        ...
        mFollowRecordAdapter.setRecordList(recordList);
    }
