...
public final class EnhanceTabLayout extends FrameLayout {
    ...
    private void readAttr(Context context, AttributeSet attrs) {
        ...
        mSelectIndicatorColor = typedArray.getColor(R.styleable.EnhanceTabLayout_tabIndicatorColor, context.getColor(R.color.colorAccent));
        mUnSelectTextColor = typedArray.getColor(R.styleable.EnhanceTabLayout_tabTextColor, Color.parseColor("#666666"));
        mSelectTextColor = typedArray.getColor(R.styleable.EnhanceTabLayout_tabSelectTextColor, context.getColor(R.color.colorAccent));
