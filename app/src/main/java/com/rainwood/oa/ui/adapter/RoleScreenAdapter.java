 ...
 * @Desc: 角色条件筛选
 */
public final class RoleScreenAdapter extends RecyclerView.Adapter<RoleScreenAdapter.ViewHolder> {

    private Context mContext;
    private List<RoleCondition> mList;

    public void setList(List<RoleCondition> list) {
        mList = list;
    ...
    public interface OnClickItemRoleCondition {
        /**
         * 点击item
         *
         * @param condition
         * @param position
         */
        void onClickItem(RoleCondition condition, int position);
    }

    private OnClickItemRoleCondition mRoleCondition;

    public void setRoleCondition(OnClickItemRoleCondition roleCondition) {
