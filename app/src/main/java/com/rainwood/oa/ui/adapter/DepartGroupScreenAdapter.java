 ...
 * @Desc: 部门二级条件筛选（所属小组）
 */
public final class DepartGroupScreenAdapter extends RecyclerView.Adapter<DepartGroupScreenAdapter.ViewHolder> {

    private Context mContext;
    private List<ProjectGroup> mList;

    public void setList(List<ProjectGroup> list) {
        mList = list;
//         mList.clear();
//         mList.addAll(list);
    ...
    public interface OnClickSecondRoleCondition {
         ...
         * @param position
         */
        void onClickSecondItem(ProjectGroup secondCondition, int position);
    }
