...
public final class ContactImpl implements IContactPresenter {
    ...
    public void getAllContact() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            contact.setPost("极限冒险家");
            contact.setTelNum("135 1525 0074");
            contact.setSpecialPlane("400 0000 0000");
            contact.setWxNum("chen0074");
            contact.setQqNum("1175039036");
            contact.setNote("肖主管专门负责和乙方公司的对接，上午9点到晚上11点都可以随时联系，每周五下午例会时间不能及时回复。");
